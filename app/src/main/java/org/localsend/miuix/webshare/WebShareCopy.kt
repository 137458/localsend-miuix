...
data class WebShareCopy(
    ...
    fun jsMap(): Map<String, String> = mapOf(
        "copied" to copied,
    ...
    companion object {
        ...
        fun fromAcceptLanguage(header: String?): WebShareCopy =
            if (prefersEnglish(header)) English else Chinese
        ...
        fun browserModel(userAgent: String, copy: WebShareCopy = Chinese): String {
            return when {
